            ...
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Chat with your PDFs intelligently</p>
                    </div>
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <p className="mt-10 text-center text-sm/6 text-gray-500 dark:text-gray-400">
                        ...
                        <a href="/signup" className="font-semibold text-orange-600 hover:text-orange-500 dark:text-orange-400 dark:hover:text-orange-300">
                            Sign up
                        </a>
                    </p>
                </div>
